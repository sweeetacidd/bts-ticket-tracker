...
TIPO_KEYWORDS = [
    "arquibancada", "cadeira inferior", "cadeira superior",
    "camarote experience", "camarote ídolos", "camarote clássico",
    "camarote", "pista premium", "pista", "cadeira",
    "vip", "meia-entrada", "inteira", "setor", "front stage", "lounge",
]

# Aceita "R$ 2.500" (sem centavos) ou "R$ 2.500,00" (com centavos)
